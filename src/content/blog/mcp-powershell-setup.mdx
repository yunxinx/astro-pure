...
description: '记录一下在 Windows 上使用 Cursor 或者 Roocode 的时候，通过 PowerShell 配置 Mcp 服务器的方法'
publishDate: '2025-05-31 19:31:00'
tags:
  - AI
  - MCP
---
...
<Aside type="caution" title="重要">
  这篇文章的图片使用的是一个免费图床，如果图片加载不出来请见谅，因为个人原因暂不考虑迁移，如影响到阅读请通过页面底部邮件方式联系我进行修复<br/>
  本文最先发布在：https://linux.do/t/topic/624552 上，建议去原贴查看
</Aside>

## 前言
> 如果嫌前言啰嗦，可以直接跳转到后文 “改用 Powershell” 部分<br/>
> 没有使用 CMD，哪怕我后面发现在 Powershell 中启动 Mcp 服务器，实际上也是在 CMD 中启动的<br/>
...
<img
    src="https://free.picui.cn/free/2025/06/01/683c31b4d6736.png"
    alt="cursor"
    loading="lazy"
    decoding="async"
    class="mx-auto block w-1/2"
/>
